...
import 'package:todo/utilities/dialgos/cannot_share_empty_note.dart';
//import 'package:todo/services/crud/notes_service.dart';
import 'package:todo/utilities/generics/get_aurgments.dart';
...
//if user selects update then the text is copied and pasted in the text section of new note for updating
    if (widgetNote != null) {
      _note = widgetNote;
    ...
    // final owner = await _notesService.getUser(email: email);  //no meed for this as now users are manged by firebase
